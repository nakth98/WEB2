...
# 배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\user\\Desktop\\cor\\pygame.basic\\제목 없음.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\user\\Desktop\\cor\\pygame.basic\\character.png")
